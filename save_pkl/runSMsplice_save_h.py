...
# time python runSMsplice_save_h.py -c ./canonical_datasets/lengthfilter_canonical_dataset_hg19.txt -a ./allSS_datasets/allSS_dataset_hg19.txt -g ./hg19.fa -m ./maxEnt_models/human/ --print_predictions --learning_seed real-decoy --max_learned_weights 15 --max_learned_scores 1000 --learn_sre
