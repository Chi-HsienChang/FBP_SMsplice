...
# time python runSMsplice_save_o.py -c ./canonical_datasets/lengthfilter_canonical_dataset_Bmori.txt -a ./allSS_datasets/allSS_dataset_Bmori_2016v1.0.txt -g ./moth.fa -m ./maxEnt_models/moth/ --print_predictions --learning_seed real-decoy --max_learned_weights 15 --max_learned_scores 1000 --learn_sre
