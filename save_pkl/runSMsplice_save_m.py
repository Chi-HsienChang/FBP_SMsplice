...
# time python runSMsplice_save_m.py -c ./canonical_datasets/lengthfilter_canonical_dataset_mm10.txt -a ./allSS_datasets/allSS_dataset_mm10.txt -g ./GRCm38.fa -m ./maxEnt_models/mouse/ --print_predictions --learning_seed real-decoy --max_learned_weights 15 --max_learned_scores 1000 --learn_sre
...
# 將字典儲存到 pickle 檔案
with open(f'm_new_{my_seed}.pkl', 'wb') as f:
    pickle.dump(data, f)
