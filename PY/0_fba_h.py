...
fold_name = f"./0_h_result/h_result_{top_k}"
output_filename = f"./0_h_result/h_result_{top_k}/000_human_g_{g_index}.txt"  # 設定輸出檔名
import os
...
with open('h_predictions_new.pkl', 'rb') as f:
    data = pickle.load(f)
