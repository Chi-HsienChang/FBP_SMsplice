...
fold_name = f"./0_t_result/t_result_{top_k}"
output_filename = f"./0_t_result/t_result_{top_k}/000_arabidopsis_g_{g_index}.txt"  # 設定輸出檔名
import os
