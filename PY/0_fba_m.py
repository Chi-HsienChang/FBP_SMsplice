...
fold_name = f"./0_m_result/m_result_{top_k}"
output_filename = f"./0_m_result/m_result_{top_k}/000_mouse_g_{g_index}.txt"  # 設定輸出檔名
import os
