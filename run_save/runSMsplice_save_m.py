...
# time python runSMsplice_save_m.py -c ./canonical_datasets/canonical_dataset_mm10.txt -a ./allSS_datasets/allSS_dataset_mm10.txt -g ./GRCm38.fa -m ./maxEnt_models/mouse/ --print_predictions --learning_seed real-decoy --max_learned_weights 15 --max_learned_scores 1000 --learn_sre
