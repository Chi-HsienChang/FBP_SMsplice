...
for i in range(0, 1938):  # 循环遍历指定索引范围
    ...
    fold_name = f"./{my_seed}_f_exon_score/f_result_1000"
    output_filename = f"./{my_seed}_f_exon_score/f_result_1000/000_fly_g_{i}.txt"  # 注意这里用 i 作为文件名的一部分，避免重复写入同一个文件
    import os
    ...
    # print("last_exon_dict ", last_exon_dict)
